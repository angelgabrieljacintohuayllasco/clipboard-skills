...
<p align="center">
  <img src="assets/clipboard-soyjak.jpg" alt="Clipboard Skills — el agente que revisa la lista antes de decir listo" width="640">
</p>

<h1 align="center">clipboard-skills</h1>

<p align="center"><b>Tu agente de IA dice "listo" sin haber corrido un solo test.<br>Clipboard Skills lo obliga a revisar la lista primero.</b></p>
...
> Las skills están escritas en español. Cada `description` lleva también frases de disparo en inglés, así que se activan en los dos idiomas y el agente responde en el idioma que uses.
